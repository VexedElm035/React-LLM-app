      ...
      {chatbotState === 1 ? (
        <div className='chat-button'>
          <button onClick={toggleChatbot}>
            <svg
              xmlns="http://www.w3.org/2000/svg" width="55" height="55" viewBox="0 0 24 24" fill="none" stroke="#FFF" stroke-width="1" stroke-linecap="round" stroke-linejoin="round"
            >
          ...
          <div className='chat-float-container'>
            <button className='close-button' onClick={toggleChatbot}>cerrar chat</button>
            <Chatbot />
          </div>
